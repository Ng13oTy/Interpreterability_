...
import numpy as np
from My_Explainer.GNNExplainer import GNNExplainer
...
for m_type in model_types:
    ...
    for i in range(4):
        ...
        for exp_time in range(10):
            ...
            explainer = GNNExplainer(epochs=epochs)
            ...
            with open('result/{}/{}_best_model_{}_gnne_{}.csv'.format(m_type, m_type, i, exp_time),
                      'w', newline='') as f:
                writer = csv.writer(f)
